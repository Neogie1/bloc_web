          ...
          <div class="mt-5 text-center">
            <div class="text-center">
              <img
                ...
                style="flex-shrink: 0;"
              />
              <h3 class="login-title">Supprimez un compte</h3>
              <a href="delete_pilote.php" class="bi bi-person btn btn-primary w-100 mt-4">
                Pilote
                </a>
                <a href="admin_delete_etudiant.php" class="bi bi-person btn btn-primary w-100 mt-4">
                Étudiant
                </a>
              </form>
            </div>
            ...
            <p class="login-footer text-muted mb-0 mt-md-4 mt-4">
              Créer un compte ?
              <a href="create_account.php" class="signup-link">ici</a>
            </p>
          </div>
            </div>
          </div>
