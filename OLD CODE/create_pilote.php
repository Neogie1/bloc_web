          ...
          <div class="mt-5 text-center">
            <div class="text-center">
              <img
                ...
                style="flex-shrink: 0;"
              />
              <h3 class="login-title">Créez un compte pilote</h3>
              <form class="login-form w-100" method="POST" action="">
                ...
                <div class="mb-3">
                  <label for="text" class="form-label">Prénom du pilote</label>
                  <input
                    type="text"
                    class="form-control"
                    id="prenom"
                ...
                <div class="mb-3">
                  <label for="text" class="form-label">Nom du pilote</label>
                  <input
                    type="text"
                    class="form-control"
                    id="nom"
            ...
            <div class="mt-auto text-center">
              <p class="login-footer text-muted mb-0 mt-md-2 mt-4"><br />
                <a href="delete_pilote.php" class="signup-link">Supprimer un pilote ?</a>
              </p>
            </div>
          </div>
        </div>
