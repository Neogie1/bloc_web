      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown mx-3">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="create_account.php">Créer un compte</a></li>
            <li><a class="dropdown-item" href="delete_account.php">Supprimer un compte </a></li>
          ...
          <div class="mt-5 text-center">
            <div class="text-center">
              <img
                ...
                style="flex-shrink: 0;"
              />
              <h3 class="login-title">Créez un compte</h3>
              <a href="create_pilote.php" class="bi bi-person btn btn-primary w-100 mt-4">
                Pilote
                </a>
                <a href="admin_create_etudiant.php" class="bi bi-person btn btn-primary w-100 mt-4">
                Étudiant
                </a>
              </form>
            </div>
            <div class="mt-auto text-center">
              <p class="login-footer text-muted mb-0 mt-md-2 mt-4"><br />
                <a href="delete_account.php" class="signup-link">Supprimer un compte ?</a>
              </p>
            </div>
          </div>
        </div>
