...
class ForcedAuthMiddleware
{
    ...
    public function __invoke(Request $request, Handler $handler): Response
    {
        ...
        error_log('ForcedAuthMiddleware - Session content: ' . print_r($this->session->get('user'), true));
        
        if (!$this->session->exists('user')) {
            error_log('ForcedAuthMiddleware: User not authenticated, redirecting to login');
        ...
        error_log('ForcedAuthMiddleware: User authenticated, proceeding');
